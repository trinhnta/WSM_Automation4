...
public class InformationTest {
    ...
    public static final String datatest12[] = {"FFL x FVN QONECT APP", "2018/10/27 19:00", "2018/10/27 22:00", "Test"};
    public static final String ouput12[] = {"B121259", "Nguyen Thi Hang", "10-29-2018", "19:00 10-29-2018", "22:00 10-29-2018", "FFL x FVN QONECT APP", "Test", "Pending",
            "Software Development Division HIGH(Nguyen Xuan Son, Dinh Thanh Tam, Vu Bui Nhat Uyen)", "3.0"};
    public static final String datatest13[] = {"FFL x FVN QONECT APP", "2018/10/25 18:00", "2018/10/25 21:00", "Test"};
    public static final String ouput13[] = {"B121259", "Nguyen Thi Hang", "10-29-2018", "18:00 10-25-2018", "21:00 10-25-2018", "FFL x FVN QONECT APP", "Test", "Pending",
            "Software Development Division HIGH(Nguyen Xuan Son, Dinh Thanh Tam, Vu Bui Nhat Uyen)", "3.0"};
    public static final String datatest14[] = {"FFL x FVN QONECT APP", "2019/10/25 18:00", "2019/10/25 21:00", "Test"};
    public static final String ouput14[] = {"B121259", "Nguyen Thi Hang", "10-29-2018", "18:00 10-25-2019", "21:00 10-25-2019", "FFL x FVN QONECT APP", "Test", "Pending",
            "Software Development Division HIGH(Nguyen Xuan Son, Dinh Thanh Tam, Vu Bui Nhat Uyen)", "3.0"};
    public static final String datatest15[] = {"FFL x FVN QONECT APP", "2018/10/24 18:00", "2018/10/24 21:00", "Test"};
    public static final String datatest16[] = {"FFL x FVN QONECT APP", "2018/10/23 18:00", "2018/10/23 21:00", "Test"};
    public static final String output16 = "18:00 10-23-2018";
